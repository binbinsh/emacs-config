...
(eval-when-compile
  ;; Externally-defined commands referenced in bindings. Declaring them keeps
  ;; native compilation quiet without forcing eager requires.
  (declare-function consult-buffer "consult")
  (declare-function consult-imenu "consult")
  (declare-function consult-ripgrep "consult")
  (declare-function dired-create-directory "dired")
  (declare-function dired-do-copy "dired")
  (declare-function dired-do-delete "dired")
  (declare-function dired-do-rename "dired")
  (declare-function dired-find-file "dired")
  (declare-function dired-git-info-mode "dired-git-info")
  (declare-function fork-git-blame-toggle "setup-git")
  (declare-function fork-git-branch-graph "setup-git")
  (declare-function fork-git-file-history "setup-git")
  (declare-function fork-git-generate-commit-message "setup-git")
  (declare-function fork-git-magit-delta-toggle "setup-git")
  (declare-function fork-git-open-repo-dashboard "setup-git")
  (declare-function fork-git-show-inline-commit "setup-git")
  ...
  (declare-function markdown-live-preview-mode "markdown-mode")
  (declare-function my/ai-execute "setup-ai")
  (declare-function my/focus-explorer "setup-gui")
  (declare-function my/latex-workspace "setup-latex")
  (declare-function my/notmuch-ai-generate-reply "setup-gmail")
  (declare-function my/notmuch-ai-summarize-thread "setup-gmail")
  (declare-function my/notmuch-ai-suggest-labels "setup-gmail")
  (declare-function my/notmuch-open-gmail-ui "setup-gmail")
  (declare-function my/snippet-select-smart "setup-snippets")
  (declare-function my/toggle-soft-wrap-global "setup-gui")
  (declare-function my/toggle-vterm "setup-gui")
  (declare-function my/terminal-ai-suggest "setup-terminal")
  (declare-function my/terminal-remote-dired "setup-terminal")
  (declare-function my/terminal-ssh-connect "setup-terminal")
  (declare-function my/terminal-tunnel-list "setup-terminal")
  (declare-function my/vterm-clipboard-yank "setup-terminal")
  (declare-function notmuch-search "notmuch")
  (declare-function notmuch-search-tag "notmuch")
  (declare-function notmuch-show-tag "notmuch")
  (declare-function python-pytest "python-pytest")
  (declare-function tc/dired-toggle-preview "setup-dired")
  (declare-function tc/dired-two-panes "setup-dired")
